...
xgb_model.fit(X_train[0:1000], y_train[0:1000])
predict = xgb_model.predict(X_test[0:200])
calculateMetrics("Extreme Gradient Boosting", predict, y_test[0:200])
...
def TrainML(request):
    if request.method == 'GET':
        ...
        algorithms = ['Naive Bayes', 'Logistic Regression', 'Decision Tree', 'Random Forest', 'Gradient Boosting','Extreme Gradient Boosting', 'Propose CNN', 'Extension Hybrid CNN']
        output = ""
        output = ''
        ...
        output+="</table><br/>"
        df = pd.DataFrame([['Naive Bayes','Precision',precision[0]],
                           ['Naive Bayes','Recall',recall[0]],
                           ['Naive Bayes','F1 Score',fscore[0]],
                           ['Naive Bayes','Accuracy',accuracy[0]],
                           ['Logistic Regression','Precision',precision[1]],
                           ['Logistic Regression','Recall',recall[1]],
                           ['Logistic Regression','F1 Score',fscore[1]],
                           ...
                           ['Random Forest','Precision',precision[3]],
                           ['Random Forest','Recall',recall[3]],
                           ['Random Forest','F1 Score',fscore[3]],
                           ['Random Forest','Accuracy',accuracy[3]],
                           ['Gradient Boosting','Precision',precision[4]],
                           ['Gradient Boosting','Recall',recall[4]],
                           ['Gradient Boosting','F1 Score',fscore[4]],
                           ['Gradient Boosting','Accuracy',accuracy[4]],
                           ['Extreme Gradient Boosting','Precision',precision[5]],
                           ['Extreme Gradient Boosting','Recall',recall[5]],
                           ['Extreme Gradient Boosting','F1 Score',fscore[5]],
                           ['Extreme Gradient Boosting','Accuracy',accuracy[5]],
                           ['Propose CNN','Precision',precision[6]],
                           ['Propose CNN','Recall',recall[6]],
                           ['Propose CNN','F1 Score',fscore[6]],
                           ['Propose CNN','Accuracy',accuracy[6]],
                           ['Extension Hybrid CNN','Precision',precision[7]],
                           ['Extension Hybrid CNN','Recall',recall[7]],
                           ['Extension Hybrid CNN','F1 Score',fscore[7]],
                           ['Extension Hybrid CNN','Accuracy',accuracy[7]],
